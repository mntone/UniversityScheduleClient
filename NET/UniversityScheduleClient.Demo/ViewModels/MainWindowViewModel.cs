using Livet;
using Mntone.UniversityScheduleClient.Demo.Core;

namespace Mntone.UniversityScheduleClient.Demo.ViewModels
{
		...
		: ViewModel
	{
		...
		private ObservableSynchronizedCollection<Class> _Classes = new ObservableSynchronizedCollection<Class>();
